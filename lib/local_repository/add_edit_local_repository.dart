...
class AddEditLocalRepositoryPage extends StatefulWidget {
  final bool isNew;
  final SongItem? songItem;

  const AddEditLocalRepositoryPage(
      {Key? key, required this.isNew, this.songItem})
      : super(key: key);

  @override
  _AddEditLocalRepositoryPage createState() => _AddEditLocalRepositoryPage();
}

class _AddEditLocalRepositoryPage extends State<AddEditLocalRepositoryPage> {
